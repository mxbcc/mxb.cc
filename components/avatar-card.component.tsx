...
export const AvatarCard = ({ title, avatar, postCount, commentCount, tagCount, style, background }: AvatarCardProps) => {
    return <section
        className="
            min-h-avatar-card w-104 h-104 border border-solid border-gray-100
            bg-white mb-8 dark:bg-zinc-800 dark:border-none
        "
        style={style}>
        ...
        <ul className="flex border-t border-solid border-gray-100 dark:border-neutral-900">
